...
let homeOption = {
  ...
  series : [{
    ...
    radius : '80%',
    center: ['50%', '55%'],
    data:usedCarRank.slice(0, 10).sort(function (a, b) { return a.value - b.value; }),
    roseType: 'radius',
    label: {
        normal: {
            textStyle: {
...
return {
    ...
    tooltip : {
      ...
      formatter: function (params) {
        return `${params.data.name} 订单数量 : ${params.data.value[2]}`
      }
    },
    bmap: {
        center: [104.114129, 33],
        zoom: 5,
        roam: true,
    },
    series : [
